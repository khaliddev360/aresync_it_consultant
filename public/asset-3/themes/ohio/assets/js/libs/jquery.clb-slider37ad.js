            ...
            return this.each(function(){
                ...
                function createHtmlMarkup(settings) {
                    if ( !slider.hasClass('clb-slider') ) {
                        ...
                        if (settings.navBtn) {
                            var createNavBtn = '<div class="clb-slider-nav-btn"><div class="prev-btn btn-round btn-round-light ' + settings.navBtnClasses + '" tabindex="0"><i class="ion"><svg id="scroll-track" class="arrow-icon arrow-icon-back" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 8H15M15 8L8.5 1.5M15 8L8.5 14.5" stroke-width="2" stroke-linejoin="round"/></svg></i></div><div class="next-btn btn-round btn-round-light ' + settings.navBtnClasses + '" tabindex="0"><i class="ion"><svg id="scroll-track" class="arrow-icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 8H15M15 8L8.5 1.5M15 8L8.5 14.5" stroke-width="2" stroke-linejoin="round"/></svg></i></div></div>';
